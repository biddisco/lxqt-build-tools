...
{
  {
    ...
    currency_code c2{currency_issuers::bitstamp_trust, "USD"};
    std::stringstream s1;
    s1 << c1;
  ...
  {
    currency_code c1{currency_issuers::bitstamp_trust, "USD"};
    currency_code c2{currency_issuers::bitstamp_trust, "USD"};
    EXPECT_TRUE(c1 == c2);
  }
  {
...
TEST(currency, currency_amount)
{
  ...
  {
    currency_amount c1{{currency_issuers::bitstamp_trust, "USD"}, 0.0};
    currency_amount c2{{currency_issuers::bitstamp_trust, "USD"}, 0.0};
    EXPECT_TRUE(c1 == c2);
  }
  {
...
TEST(currency, currency_pair)
{
  {
    currency_code c1{currency_issuers::bitstamp_trust, "USD"};
    currency_code c2{currency_issuers::bitstamp_trust, "XRP"};
  ...
  {
    currency_pair cp1{
        {currency_issuers::bitstamp_trust, "USD"}, {currency_issuers::bitstamp_trust, "XRP"}};
    currency_pair cp2{
        {currency_issuers::bitstamp_trust, "EUR"}, {currency_issuers::bitstamp_trust, "XRP"}};
    EXPECT_TRUE(cp2 < cp1);
    EXPECT_FALSE(cp2 > cp1);
  }
  {
    currency_pair cp1{{"", "USD"}, {"", "XRP"}};
    currency_pair cp2{{currency_issuers::bitstamp_trust, "USD"}, {"", "XRP"}};
    currency_pair cp3{
        {currency_issuers::bitstamp_trust, "EUR"}, {currency_issuers::ripple_trust, "USD"}};
    //
  ...
  }
  {
    currency_pair cp1{
        {currency_issuers::bitstamp_trust, "EUR"}, {currency_issuers::ripple_trust, "USD"}};
    currency_pair cp2{
        {currency_issuers::ripple_trust, "USD"}, {currency_issuers::bitstamp_trust, "EUR"}};
...
TEST(currency, map)
{
  currency_pair::list pairs{
      ...
      {{"", "USD"}, {"", "EUR"}},                                                              //
      {{"", "USD"}, {"", "GBP"}},                                                              //
      {{"", "EUR"}, {currency_issuers::ripple_trust, "USD"}},                                  //
      {{"", "GBP"}, {currency_issuers::ripple_trust, "USD"}},                                  //
      {{"", "BTC"}, {currency_issuers::ripple_trust, "USD"}},                                  //
      {{currency_issuers::bitstamp_trust, "GBP"}, {currency_issuers::ripple_trust, "USD"}},    //
      {{currency_issuers::bitstamp_trust, "EUR"}, {currency_issuers::ripple_trust, "USD"}},    //
      {{currency_issuers::ripple_trust, "USD"}, {currency_issuers::gatehub_trust, "EUR"}}      //
  };
  {
