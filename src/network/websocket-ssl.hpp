...
namespace net {
    ...
    namespace ws {
        ...
        // encapsulate websocket and rest API handling here
        ...
        public:
            ...
            void on_resolve(boost::beast::error_code ec, tcp::resolver::results_type results)
            {
                ...
                boost::beast::get_lowest_layer(ws_).async_connect(results,
                    boost::beast::bind_front_handler(&session::on_connect, shared_from_this()));
            }

            void on_connect(
                boost::beast::error_code ec, tcp::resolver::results_type::endpoint_type ep)
            {
                if (ec)
            ...
            void on_read(boost::beast::error_code ec, std::size_t bytes_transferred)
            {
                ...
                std::string str_buffer = boost::beast::buffers_to_string(buffer_.data());
                buffer_.clear();
