...
int main(int argc, char** argv)
{
  ...
  asio::executor_work_guard<asio::io_context::executor_type> work_guard_{
    boost::asio::make_work_guard(contexts.ioc)};
  ...
  std::shared_ptr<net::ws::session> session =
    net::ws::create_session(contexts.ioc, contexts.ctx, host, port, channel, &new_trade_data);
