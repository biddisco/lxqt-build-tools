...
namespace stdexec {
  ...
  namespace __qtmain {
    ...
    struct __scheduler
    {
      ...
      friend forward_progress_guarantee tag_invoke(
        get_forward_progress_guarantee_t, __scheduler) noexcept
      {
  ...
  template <>
  struct __sexpr_impl<__qtmain::__schedule_t> : __sexpr_defaults
  {
    static constexpr auto get_attrs =    //
      [](__ignore) noexcept
      -> __env::__prop<__qtmain::__scheduler(get_completion_scheduler_t<set_value_t>)> {
      return __mkprop(__qtmain::__scheduler{}, get_completion_scheduler<set_value_t>);
    };
    ...
    static constexpr auto start =    //
      ...
      // call set value on the receiver of this sender
      ...
      grox::qt::experimental::detail::qt_function_type func = [rcvr = std::move(__rcvr)](bool x) {
        set_value((_Receiver &&) rcvr);
        return x;
      };
...
namespace grox {
  ...
  using qt_mainthread_scheduler = stdexec::__qtmain::__scheduler;
}    // namespace grox
