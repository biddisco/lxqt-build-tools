...
void aes_encrypt(const byte *key, const byte *iv, const secure_string& instring, secure_string& outstring);
void aes_decrypt(const byte *key, const byte *iv, const secure_string& instring, secure_string& outstring);
